package com.example.abdulmusse_comp304lab5_ex1
...
import com.example.abdulmusse_comp304lab5_ex1.databinding.ActivityMaps2Binding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    /**
     * Callback triggered upon map readiness.
     * Enables addition of markers, lines, listeners, or camera adjustments.
     * For this instance, a marker is placed near Sydney, Australia.
    ...
    private fun showPopup(places: List<Place>) {
    ...
    fun removeDuplicatePlaces(places: List<Place>): MutableList<Place> {
        val uniquePlaces = mutableListOf<Place>()
